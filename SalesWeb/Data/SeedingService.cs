...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@email.com", new DateTime(1979, 12, 31), 1200.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@email.com", new DateTime(2000, 6, 30), 1000.0, d3);
            Seller s4 = new Seller(4, "Martha Red", "martha@email.com", new DateTime(1996, 2, 1), 1050.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@email.com", new DateTime(1998, 5, 12), 1000.0, d1);
            Seller s6 = new Seller(6, "Alex Pink", "alexp@email.com", new DateTime(1998, 12, 11), 2000.0, d2);
